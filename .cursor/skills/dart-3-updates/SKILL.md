---
name: dart-3-updates
description: Applies Dart 3 language features in Flutter/Dart code—branches (if-case, switch statements/expressions, guards, exhaustiveness), patterns and pattern types, and records. Use when writing or reviewing conditionals, switch, destructuring, sealed hierarchies, JSON-shaped validation, multiple return values, or when the user mentions Dart 3, patterns, records, or data classes vs records.
---

# Dart 3 Updates

Defines how to use Dart 3 branches, patterns, pattern types, and records. Based on [evanca/flutter-ai-rules dart-3-updates](https://github.com/evanca/flutter-ai-rules/blob/main/skills/dart-3-updates/SKILL.md).
